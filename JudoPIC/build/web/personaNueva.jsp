                        ...
                        <form class="was-validated" action="ControladorPer?menu=Persona" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="col-md-2 mb-5">
                                    ...
                                    <select type="text" value="${peredit.getTipo()}" name="txtTipo" class="form-control" id="validationTooltip08" pattern="Deportista|Entrenador"  oninvalid="setCustomValidity('Por favor seleccione un campo valido')" required>
                                ...
                                <div class="col-md-2 mb-5">
                                    ...
                                    <select type="text" value="${peredit.getGrado()}" name="txtGrado" class="form-control" id="validationTooltip09" pattern="^([1-6] Kyu|[1-7] Dan)$"  oninvalid="setCustomValidity('Por favor seleccione un campo valido')" required>
                                        <option></option>
                                        <option>6 Kyu</option>
                                        <option>5 Kyu</option>
                                        <option>4 Kyu</option>
                                ...
                                <div class="col-md-2 mb-5">
                                    ...
                                    <select type="text" value="${peredit.getSexo()}" name="txtSexo" class="form-control" id="validationTooltip11" pattern="Masculino|Femenino"  oninvalid="setCustomValidity('Por favor seleccione un campo valido')">
                                        <option></option>
