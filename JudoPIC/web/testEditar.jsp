                        ...
                        <form class="was-validated" action="ControladorPer?menu=Test" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="text" value="${testedit.getUshikomi()}" name="txtUshikomi" class="form-control" id="validationTooltip12" pattern="^([0-9]|[1-9][0-9]|100)$"  oninvalid="setCustomValidity('Ingrese un numero valido entre 0-100')" >
                                    <div class="invalid-feedback">
                                        Ingrese un número entre 0-100!
                                    </div>
                                </div>                 
